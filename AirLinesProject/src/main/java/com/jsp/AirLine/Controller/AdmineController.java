...
public class AdmineController {
    ...
    @PostMapping("/flight/{fareId}/{flightInfoId}/{inventoryId}")
	...
	public FlightDTO getflightById(@PathVariable("flightId") int flightId)
	{
		FlightDTO flightDTO=adminService.findFlightById(flightId);
		if(flightDTO!=null)
		{
			return flightDTO;
		}
	...
	public AirLine_Info_DTO getAirlinebyId(@PathVariable("airlineid") int airLineId)
	{
		AirLine_Info_DTO  airLineinfodto=adminService.findAirlineById(airLineId);
		if(airLineinfodto!=null)
		{
